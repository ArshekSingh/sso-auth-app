...
<html lang="en">
<head>
	<title>Login | SAS Techstudio SSO</title>
	<meta charset="UTF-8">
...
<body>
	...
	<div class="limiter">
		<div style="    background: #db2228;" class="container-login100">
			<div class="wrap-login100">
				...
				<form:hidden path="appName"/>
					...
					<div class="wrap-input100 validate-input" data-validate = "Password is required">
						<form:input class="input100" type="password" placeholder="Enter Password" path="password" required="true"/>
						<span class="focus-input100"></span>
						<span class="symbol-input100">
